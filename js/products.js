    ...
    product => ` 
                  <div class="product category__products">
                    ...
                    <div class="product__footer">
                      ...
                      <div class="rating">
                        <svg>
                          <use xlink:href="./images/graphics.svg#icon-star-full"></use>
                        </svg>
                        <svg>
                          <use xlink:href="./images/graphics.svg#icon-star-full"></use>
                        </svg>
                        ...
                        <svg>
                          <use xlink:href="./images/graphics.svg#icon-star-empty"></use>
                        </svg>
                      </div>
                  ...
                  <ul>
                      <li>
                        <a data-tip="Quick View" data-place="left" href="#">
                          <svg>
                            <use xlink:href="./images/graphics.svg#icon-eye"></use>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a data-tip="Add To Wishlist" data-place="left" href="#">
                          <svg>
                            <use xlink:href="./images/graphics.svg#icon-heart-o"></use>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a data-tip="Add To Compare" data-place="left" href="#">
                          <svg>
                            <use xlink:href="./images/graphics.svg#icon-loop2"></use>
                          </svg>
                        </a>
                      </li>
                  </ul>
